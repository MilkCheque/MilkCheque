...
public class StaffModel {
  ...
  @Column(name = "staff_first_name", unique = false, nullable = false)
  private String staffFirstName;

  @Column(name = "staff_last_name", unique = false, nullable = false)
  ...
  @Column(name = "staff_phone", unique = true, nullable = false)
